...
def cere_memorie():
    # MODIFICARE: NU mai ștergem memoria instantaneu aici, lăsăm PC-ul să o suprascrie când e gata
...
def get_memorie():
    ...
    # Dacă dicționarul e gol, înseamnă că nu a sosit încă nimic de la PC
    if not mesaje_eeprom:
        return jsonify({"Info": "Se încarcă datele din hardware... Reîncărcați pagina în 3 secunde."})
